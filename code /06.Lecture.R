...
# you can see NO2 high level mainly in Italy in red
# before Covid - January
# also large levels during this period of NO2 in large capital cities like Madrid 
EN13 <- im.import("EN_13.png")   
# in March situation - low amount of NO2 - nitrogen 
par(mfrow=c(2,1))
im.plotRGB.auto(EN01)           
# auto - automatically selects 3 bands
im.plotRGB.auto(EN13)           
# plots 1 column 2 rows - difference between JANUARY and MARCH
