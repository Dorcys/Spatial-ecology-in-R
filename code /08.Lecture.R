...
library(ncdf4)
# library we need to read .NC files 
library(terra)  
# package needed for importing data from outside R
...
ext <- c(22,23,55,57)                           
# minlongitude, maxlong, minlatitude, maxlat  
# defining the extent in space which you want 
soilm2023crop <- crop(soilm2023,ext)            
# crop crops the image you want, ext means to that extent you set previously and name it new variable
plot(soilm2023crop[[1]], col=cl)                
# selecting first element with [[1]]
### CROP!!!
