...
plot(b8, col=cln)
dev.off () 
# closes the device, clears the workspace in R
# RGB space
# stacksent: 
...
# red band is number 3, blue is number 1, green is 2 
im.plotRGB (stacksent, r=4, g=3, b=2)          
# infrared - dark red part is broad leaf forest, light red is pasture - everyhing red is vegetation (red band above others)
...
# changing the green above the red - everything that is becoming green is vegetation
...
# now everything reflecting in infrared is becoming blue
...
pairs(stacksent)          
# wait for it - plotting many data 
