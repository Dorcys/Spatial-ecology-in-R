...
sentpc <- im.pca2(sent)     
sentpc              
# we can see first component is called PC1 and we can isolate it
pc1 <- sentpc$PC1 
plot(pc1)
...
# similar to infra red but calculated to objectively selected layer 
# plot in 7x7 window
...
plot(pc1sd3, col=viridisc)
plot(pc1sd7, col=viridisc)     
# 7 images inside final plot
# stack all the standard deviation layers 
sdstack <- c(sd3, sd7, pc1sd3, pc1sd7) 
names(sdstack) <- c("sd3", "sd7", "pc1sd3", "pc1sd7")      
# adding names to all 4 plots 
